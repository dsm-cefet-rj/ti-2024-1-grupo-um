        ...
        <div className="row">
            <div className="col-lg-4">
              ...
              <div className="card mb-4 mb-md-0">
                ...
                <p classNameName="mb-4" style={{fontWeight: "bold"}}>Biografia</p>
                <p classNameName="mb-1" style={{fontSize: "0.85rem"}}>Meu nome é Fulaninho de Tal. Sou um personal trainer apaixonado por fitness e bem-estar. Nasci e cresci em São Paulo e desde pequeno sempre fui ligado aos esportes.
